...
// Modified user route to buy Heroku account with enhanced verification
router.post('/buy-heroku-account', isLoggedIn, async (req, res) => {
    ...
    try {
        ...
        // Try accounts one by one until we find a valid one
        ...
        // Proceed with purchase using the valid account
        await connection.query(
