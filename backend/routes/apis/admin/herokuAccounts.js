...
// Modified admin route to view accounts with validity status
router.get('/admin/heroku-accounts', isAdmin, async (req, res) => {
    ...
    // Add a new admin route to check account validity
    app.post('/admin/check-account-validity', isAdmin, async (req, res) => {
