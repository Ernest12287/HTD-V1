...
// Get users with additional filtering and account count tracking
router.get('/admin/users', isAdmin, async (req, res) => {
    try {
        // Get users with account count using user_devices table for IPs
...
// Get users with additional filtering and account count tracking
// Get users with IP tracking information
router.get('/admin/users', isAdmin, async (req, res) => {
    try {
        const [users] = await pool.query(`
            SELECT 
...
// Get IP account tracking details
