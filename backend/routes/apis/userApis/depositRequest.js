...
// Modified deposit endpoint with moderator notification
router.post('/api/deposit-coins', isLoggedIn, attachUserCountry, upload.single('paymentScreenshot'), async (req, res) => {
    ...
    try {
        ...
        // Verify payment method exists and is available for user's country
        ...
        try {
            ...
            // Prepare deposit details for notification
...
// Updated user transactions endpoint
