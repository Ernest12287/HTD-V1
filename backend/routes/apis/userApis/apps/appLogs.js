...
wss.on('connection', async (ws, req) => {
    ...
    // Get user email from session or use default redacted value
...
// Updated processLogLine function with email replacement and better error handling
function processLogLine(line, userEmail = '[REDACTED EMAIL]') {
    try {
        ...
        if (matches) {
            // Replace any email addresses in the message part
        ...
        // For raw messages, still replace emails
