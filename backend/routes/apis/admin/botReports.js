...
// API route to get single report details
router.get('/api/admin/report/:id', isAdmin, async (req, res) => {
    ...
    // Updated main admin reports route to include phone number in the table
    ...
    // Fetch reports with pagination and phone number
    const [reports] = await pool.query(
        `SELECT 
            br.*,
            b.name as bot_name,
    ...
    // Render the reports page with all the data
