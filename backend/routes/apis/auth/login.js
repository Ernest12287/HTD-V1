...
// SQL Queries - Removed ip_bans table reference
...
// Rate limiting function with improved cleanup
...
// Improved IP detection with validation
...
// Optimized login route with better transaction handling
router.post('/login', async (req, res) => {
    ...
    try {
        ...
        // Query user with correct index hint
        ...
        // Create unverified device record with deadlock prevention
        ...
        // Store verification details with expiration
