...
// Modified deploy endpoint with email and dev_email
router.post('/deploy', isLoggedIn, async (req, res) => {
    ...
    try {
        ...
        // Deploy the bot with custom app name
        ...
        // Handle transaction with revenue sharing
        const connection = await pool.getConnection();
        await connection.beginTransaction();

        try {
            // Lock user's coins row
            ...
            res.json({
                ...
                // appUrl: `https://${herokuAppName}.herokurouter.com`,
