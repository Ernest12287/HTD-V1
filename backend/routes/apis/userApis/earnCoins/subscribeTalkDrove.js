...
// Add new endpoint to check subscription status
...
router.post('/api/youtube-subscribe', isLoggedIn, async (req, res) => {
    ...
    async function attemptTransaction() {
        ...
        try {
            ...
            // First, check if already subscribed with a FOR UPDATE lock
            ...
            // Execute operations in a specific order to prevent deadlocks
