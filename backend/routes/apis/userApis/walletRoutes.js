...
// Updated wallet route to use email
router.get('/api/wallet', isLoggedIn, async (req, res) => {
    try {
        const userEmail = req.session.user.email;
        
        // Query to get user info and wallet details by email
