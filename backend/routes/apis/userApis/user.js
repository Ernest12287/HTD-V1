...
router.get('/api/profile/:username', async (req, res) => {
    ...
    const authenticatedUserId = req.session.user.id; // Assuming you have authentication middleware

    try {
        // First get user data including country
        const [users] = await pool.query(`
        ...
        // Combine user data with bots and follow information
        const response = {
            ...users[0],
            bots: bots,
...
// Add a new route for follow/unfollow
