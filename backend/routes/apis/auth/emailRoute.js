...
async updateEmailSender(id, updateData) {
    ...
    // Reset daily counts for all senders
    ...
    // Reset hourly message email counts for a specific sender
    ...
    // Get all email senders with stats
...
function setupEmailResetJobs(pool) {
    ...
    // Hourly reset for specific email at 61-minute interval
