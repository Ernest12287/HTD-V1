...
router.post('/upload-profile-picture', isLoggedIn, upload.single('profilePicture'), async (req, res) => {
    try {
        ...
        // Use the CDN URL from the response
        ...
        if (req.file && req.file.path) {
            ...
            // Check if it's an axios error and log more details
            if (error.response) {
...
// Route to get current user's profile picture
...
// Update user profile route with additional fields
...
// Periodic cleanup for verification codes
