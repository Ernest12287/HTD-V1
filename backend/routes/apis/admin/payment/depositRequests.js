...
// Enhanced deposit approval with additional security checks
router.post('/api/approve-deposit', isAdmin, async (req, res) => {
    ...
    try {
    // Fetch transaction with proper joins and status check
...
// Updated GET endpoint for pending deposits
router.get('/api/get-pending-deposits', isAdmin, async (req, res) => {
    ...
    // Don't modify the payment_screenshot path
